...
(function CharClass(w, angular) {
    ...
    var animationList = ['Idle', 'Move_Left', 'Action'];
    ...
    function changeAnimationStyle() {
        ...
        console.log(animationList[activeIndexAnimation]);
        ...
        //spineChar.state.update(Math.random());
    ...
    function renderActiveCharAnimation(charID) {
        ...
        function renderChar() {
            ...
            var scale = Math.min(((renderer.width) * 0.7) / spineChar.width, ((renderer.height) * 0.7) / spineChar.height);
    ...
    function CharCtrl($scope) {
        ...
        w.addEventListener('gameappready', function () {
            ...
            /* gak jadi pake random chars
            w.setTimeout(function () {
                $scope.setActiveChar(w.randomInt(1, 20));
            }, 2500);
            */
        });
    };
