(function FirstRun($w) {
    ...
    function onModuleLoaded($rootScope, AppService) {
        ...
        $rootScope.$on("$includeContentLoaded", function (event, templateName) {
            ...
            if (loadedTemplate === totalTemplateToLoad) {
                // initializeSwiper();
                $w.GameApp.RunIsland(AppService.initApp);
    ...
    function InitializeModule(a, l, i, $http, $ionicLoading) {
        ...
        //a.ready(onIonicReady);

        a.ready(function () {
            onIonicReady();
            $w.GameApp.RunIsland(i.initApp);
            l.playerChars = [];
...
(function xmiLoading($w, $) {
    ...
    var enviLoading = {
        show: function (options) {
            ...
            $w.document.getElementById('enviLoader').addEventListener('click', function () {
                enviLoading.hide();
            });
        },
        hide: function (callbackFunction) {
