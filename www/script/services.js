(function ($w) {
    ...
    APP.factory('Incubators', function ($rootScope, $http, $ionicLoading) {
        ...
        Incubators.fetchFreeIncubator = function () {
            ...
            var countdown = window.GameApp.getTimeRemaining(finishOnNumber);
           // console.log(countdown)
            if (finishOnNumber > Number(Date.parse(window.GameApp.serverDate))) {
         ...
         // console.log(freeIncubator.countdown)
