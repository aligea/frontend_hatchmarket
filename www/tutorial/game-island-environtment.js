...
(function IslandEnviAnim(win) {
    ...
    function __createEnvirontment(islandId, callbackFn) {
        _this.isStop = false;
        ...
        function onSuccessGetDataOnServer() {
            console.log('before create envi');
