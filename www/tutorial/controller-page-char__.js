...
(function CharClass(w, angular) {
  ...
  function changeAnimationStyle() {
    ...
    // if (activeIndexAnimation > (spineData.animations.length - 1)) {
    //   activeIndexAnimation = 0;
    // }

    // spineChar.skeleton.setToSetupPose();
    // spineChar.update(Math.random());
    // spineChar.autoUpdate = false;
    // spineChar.state.setAnimation(0, spineData.animations[activeIndexAnimation].name, true);
